...
\begin{frame}{Key Concepts Overview}
...
\begin{frame}[shrink]{Recap: Sparse Matrix Product Notation}
...
\begin{frame}[fragile]{dMoE Forward Pass Pseudocode}
